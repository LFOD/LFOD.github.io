...
`r tufte::margin_note("_Note_: I am using this idea for a talk and I found a strip (to the left) that I think better represents this concept. The original post had [this one](http://xkcd.com/1592/).")`
