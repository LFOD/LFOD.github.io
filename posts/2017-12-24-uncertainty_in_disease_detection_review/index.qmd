...
knitr::include_graphics("../../media/uncertainty_paper/dropout_distributions.png")
```
...
knitr::include_graphics("../../media/uncertainty_paper/DR_explain.png")
```
...
knitr::include_graphics("../../media/uncertainty_paper/auc_performance.png")
```
