...
`r tufte::margin_note("*Note: this is not particularly statistically rigorous, but it is VERY fun.*")`
...
`r tufte::margin_note(paste("Phew, the", emo::ji("chicken"), "just barely made the cut."))` The purple heart seems to be the most popular emoji, which makes sense given [25% of us were #RLadies](https://twitter.com/nistara_r/status/867974699044687872)! I think it's a credit to the awesome geographic diversity that we have two different globe emojis in our top 15!
