...
`r tufte::margin_note("![](https://pbs.twimg.com/media/C0sy6CKWQAE4l_L.jpg)")`
...
`r tufte::margin_note("If you haven't installed this purrrrfect package, you can install it from GitHub.")`
